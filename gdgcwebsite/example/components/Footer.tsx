export default function Footer() {
  return (
    <footer className="bg-gdgc-blue-footer py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          {/* Left: Copyright */}
          <div className="order-2 lg:order-1">
            <p className="text-white text-lg lg:text-xl font-manrope">
              Copyright © 2025 UCSC GDGC. All rights reserved.
            </p>
          </div>

          {/* Right: Developed by */}
          <div className="order-1 lg:order-2 text-center lg:text-right">
            <div className="text-white/70 font-manrope text-lg lg:text-xl leading-relaxed">
        ...
        {/* Social Icons */}
        <div className="flex justify-center space-x-8 lg:space-x-12 mt-12">
          {/* Email */}
          <a 

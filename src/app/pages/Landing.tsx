                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 lg:mt-24">
                        ...
                        <div className="relative group flex flex-col items-center text-center">
                            <div className="relative bg-gdgc-beige rounded-full w-72 h-72 mx-auto flex items-center justify-center border-4 border-black shadow-xl overflow-hidden transform group-hover:scale-105 transition-transform duration-300">
                                <img
